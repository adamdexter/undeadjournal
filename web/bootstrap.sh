...
# We populate S1 system styles (DeadJournal is S1-era) + props/base-data/moods.
# The populate_s2() CALL is patched out in the Dockerfile because the S2 layer
# compiler triggers "MySQL server has gone away" and aborts the rest of populate.
echo "[bootstrap] 1/5  global schema + base data (S1 styles, moods, props, jobs)..."
